    ...
    <li class="list-group-item">
        <div class="media">
          ...
          <div class="media-body">
            ...
            <p class="btn-holder"><a href="{{ url('produtos/add-to-cart',$produto->id) }}" class="btn btn-info  text-center" role="button"style="border-radius: 20px;" ><i class="fa fa-plus"></i> Add to cart</a> </p>
          </div>
        </div>
      @guest
